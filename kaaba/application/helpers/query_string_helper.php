...
{	
	...
	if (isset($new_parsed_uri['aggregate'])&&isset($new_parsed_uri['day'])&&
		isset($new_parsed_uri['month'])&&isset($new_parsed_uri['year'])) {
		unset($new_parsed_uri['aggregate']);
		unset($new_parsed_uri['day']);
