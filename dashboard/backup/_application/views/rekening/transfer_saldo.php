...
if($var_ct == "rekening_virtual"){
    $caption_title = "Rekening ke Virtual";
} else if($var_ct == "virtual_rekening"){
    $caption_title = "Virtual ke Rekening";
}
?>
            ...
            <div class="col-md-9">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body form-input-data">
                        <?php if($var_ct == "rekening_virtual") { ?>
                        <div class="row">
                        ...
                        <?php } else if($var_ct == "virtual_rekening") { ?>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-lg-12">
                                <div class="form-group">
                                    <label for="nasabah_id">Pilih Rekening Nasabah Pengirim</label>
                        ...
                        <?php } else { ?>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-lg-12">
                                    <div class="form-group">
                                        <label for="tujuan_id">Pilih Rekening Nasabah Tujuan</label>
                                        <select id="tujuan_id" class="selectpicker with-ajax search-select" name="tujuan_id" data-live-search="true"></select>
                                    </div>
                                </div>
                            </div>
                            <?php } ?>
...
<script>
    ...
    var options = {
        ajax          : {
            url     : '<?php echo $this->rekening_mod->id_koperasi && $var_ct == "rekening_virtual" ? base_url() . "rekening/cari_nasabah?mod=tabungan&is_koperasi=true&status=active" : base_url() . "rekening/cari_nasabah?mod=tabungan&status=active" ?>',
            type    : 'POST',
            dataType: 'json',
            // Use "{{{q}}}" as a placeholder and Ajax Bootstrap Select will
            // automatically replace it with the value of the search query.
    ...
    var options = {
        ajax          : {
            url     : '<?php echo $this->rekening_mod->id_koperasi && $var_ct == "virtual_rekening" ? base_url() . "rekening/cari_nasabah?mod=virtual&is_koperasi=true&status=active" : base_url() . "rekening/cari_nasabah?mod=virtual&status=active" ?>',
            type    : 'POST',
            dataType: 'json',
            // Use "{{{q}}}" as a placeholder and Ajax Bootstrap Select will
            // automatically replace it with the value of the search query.
...
$(document).ready(function(){
    ...
    $("#form_transfer").bind('submit', function(e){
        ...
        $.ajax({
            url: '<?php echo base_url() ?>rekening/ajax_transfer_saldo',
            data: json_data,
            dataType: 'JSON',
            type: 'POST',
