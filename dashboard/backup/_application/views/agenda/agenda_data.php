...
<section class="content-header">
    <h1>
       Data Agenda <?= ucfirst($this->uri->rsegment(3)) ?>
        <!-- <small>it all starts here</small> -->
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Data Agenda <?= ucfirst($this->uri->rsegment(3)) ?></a></li>
    </ol>
</section>
 ...
 <section class="content">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
              <?php if($level_data_agenda == $this->session->userdata('level')) {?>
              	<div class="box-header with-border">
              		<button class="btn btn-sm btn-success" onclick=location.href="<?= base_url() ?>add_agenda"><i class="fa fa-plus-circle"></i> Tambah Agenda <?= ucfirst($this->uri->rsegment(3)) ?></button>
              	</div>
              <?php } ?>
                <div class="box-body">
                    ...
                    <tbody>
                    	<?php foreach ($agenda as $r) { ?>
                            ...
                            <td>
                              ...
                              <button class="btn btn-info" onclick=location.href="<?= base_url()?>lihat_agenda/<?= $r->id_agenda ?>"><i class="fa fa-eye"></i></button>
                    					 <button class="btn btn-success" onclick=location.href="<?= base_url()?>edit_agenda/<?= $r->id_agenda ?>"><i class="fa fa-pencil"></i></button>
                              <button class="btn btn-danger" onclick=confirmHapus(<?= $r->id_agenda?>)><i class="fa fa-trash"></i></button>
                              <?php } else {?>
                                 <button class="btn btn-info" onclick=location.href="<?= base_url()?>lihat_agenda/<?= $r->id_agenda ?>"><i class="fa fa-eye"></i></button>
                              <?php } ?>
                    				</td>
