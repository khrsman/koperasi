        ...
        <div class="col-md-7">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title"><strong><?= $event['judul'] ?></strong></h3>
                </div>
                <div class="box-body">
                    <?= $event['isi'] ?>
                </div>
                <div class="box-footer">
                    <button type="button" onClick=location.href="<?= base_url()."event/".$this->session->userdata('level_data_event'); ?>" class="btn btn-primary btn-block btn-flat">Kembali</button>
                </div>
            </div>
        </div>
</section>
