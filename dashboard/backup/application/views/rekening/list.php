        ...
        <div class="col-xs-12">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#rektabungan" data-toggle="tab">Rekening Tabungan</a></li>
                    <li class=""><a href="#rekvirtual" data-toggle="tab">Rekening Virtual</a></li>
                    <li class=""><a href="#rekloyalti" data-toggle="tab">Rekening Loyalti</a></li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="rektabungan">
                        <table class="dataUser table table-bordered table-striped">
                            ...
                            <tbody>
                            <?php foreach ($nasabah_rek_tabungan->result() as $nasabah_temp) { ?>
                                <tr>
                    ...
                    <div class="tab-pane" id="rekvirtual">
                        <table class="dataUser table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>No Rekening</th>
                            ...
                            <tbody>
                            <?php foreach ($nasabah_rek_virtual->result() as $nasabah_temp) { ?>
                                <tr>
                                    <td><a href="<?php echo base_url() . 'nasabah/' . $nasabah_temp->id_user . '/virtual/' . $nasabah_temp->no_rekening_virtual ?>"><?php echo $nasabah_temp->no_rekening_virtual ?></a></td>
                                    <td><a href="<?php echo base_url() . 'nasabah/' . $nasabah_temp->id_user ?>"><?php echo $nasabah_temp->nama_lengkap ?></a></td>
                                    <td style="text-align:right;">Rp. <?php echo number_format($nasabah_temp->saldo);?>.00</td>
                                    <td><?php echo $nasabah_temp->tanggal_transaksi_terakhir ?></td>
                                </tr>
                    ...
                    <div class="tab-pane" id="rekloyalti">
                        <table class="dataUser table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>No Rekening</th>
                            ...
                            <tbody>
                            <?php foreach ($nasabah_rek_loyalti->result() as $nasabah_temp) { ?>
                                <tr>
                                    <td><a href="<?php echo base_url() . 'nasabah/' . $nasabah_temp->id_user . '/loyalti/' . $nasabah_temp->no_rekening_loyalti ?>"><?php echo $nasabah_temp->no_rekening_loyalti ?></a></td>
                                    <td><a href="<?php echo base_url() . 'nasabah/' . $nasabah_temp->id_user ?>"><?php echo $nasabah_temp->nama_lengkap ?></a></td>
                                    <td style="text-align:right;">Rp. <?php echo number_format($nasabah_temp->saldo);?>.00</td>
                                    <td><?php echo $nasabah_temp->tanggal_transaksi_terakhir ? $nasabah_temp->tanggal_transaksi_terakhir : '-' ?></td>
                                    <td><?php echo $nasabah_temp->jenis_rekening ?></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
