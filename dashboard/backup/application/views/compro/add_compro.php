...
<div class="col-md-7">
    <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="<?= base_url() ?>tambah_compro" enctype="multipart/form-data">
                 <div class="form-group ">
                    <label for="judul">Judul Event</label>
                    <input type="text" class="form-control" placeholder="Judul Event" required=""  name="judul" />
                  </div>
                   <div class="form-group ">
                        <label for="isi_compro">Isi Event</label>
