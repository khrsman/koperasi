...
<div class="col-md-7">
    <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="<?= base_url() ?>tambah_agenda" enctype="multipart/form-data">
                 <div class="form-group ">
                    <label for="judul">Judul Agenda</label>
                    <input type="text" class="form-control" placeholder="Judul Agenda" required=""  name="judul" />
                  </div>
                   <div class="form-group ">
