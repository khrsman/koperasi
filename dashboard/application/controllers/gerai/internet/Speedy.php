...
class speedy extends CI_Controller {
	...
	function charge(){
		...
		if($this->form_validation->run() == FALSE){
			...
			if (!has_koperasi()) {
				...
				$data['page'] = "gerai/internet/speedy/speedy_charge_form_view";
			}


			$data['form_action'] 	= site_url().'gerai/internet/speedy';
			...
			redirect('gerai/internet/speedy/confirm', 'REFRESH');
		}
	...
	function report(){
		...
		$data['page'] 		 = "gerai/internet/speedy/speedy_report_form_view";
		$this->load->view('main_view',$data);
	}
