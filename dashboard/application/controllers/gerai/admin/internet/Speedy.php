...
class speedy extends CI_Controller {
	...
	function charge(){
		...
		if($this->form_validation->run() == FALSE){
			...
			$data['page'] = "gerai/admin/internet/speedy/speedy_charge_form_view";
			$data['form_action'] 	= site_url().'gerai/admin/internet/speedy';

			$data['operator_id']	= 'SPEEDY';
			$data['provider_logo'] 	= base_url('assets/compro/IMAGE/provider/pembayaran').'/'.'speedy.png';
			$data['provider_name'] 	= 'Telkom Speedy';
			...
			redirect('gerai/admin/internet/speedy/confirm', 'REFRESH');
		}
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			if ($inquiry==FALSE) {
			 die("uhuy");
	            ...
	            redirect('gerai/admin/internet/speedy/report');
			...
			$data['form_action'] = site_url('gerai/admin/internet/speedy/confirm');
			$data['page'] 		 = "gerai/admin/internet/speedy/speedy_confirm_form_view";
	...
	function report(){
		...
		$data['page'] 		 = "gerai/admin/internet/speedy/speedy_report_form_view";
		$this->load->view('main_view',$data);
	}
