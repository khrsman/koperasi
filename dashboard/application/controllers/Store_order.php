...
class Store_order extends CI_Controller {
    ...
    function l(){
        ...
        $product = $this->product_order_detail_model->get_list_by_transaksi_owner($keyword,$limit,$offset,$param_query);
        $data['product'] = NULL;
        if ($product['count']!=0) {
    ...
    function detail($no_transaksi=NULL){
        ...
        $get_order_detail = $this->product_order_detail_model->get_detail_by_transaksi_owner($param_query);
    ...
    function edit_status($no_transaksi=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['form_action'] = site_url('store_order/edit_status').'/'.$no_transaksi;
            ...
            foreach ($order_detail as $k => $v) {
                ...
                $this->product_order_detail_model->edit_detail_by_transaksi_produk($data_update);
            }
            // print_r($order_detail);
            redirect(site_url('store_order/detail').'/'.$no_transaksi);
