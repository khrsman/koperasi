...
class Rekening_mod extends CI_Model {
	...
	var $keyword, $id_user, $id_koperasi, $no_rekening, $tipe_transaksi, $kode_transaksi, $jenis_rekening, $no_transaksi, $status_rekening = "ANY", $tipe_rekening, $kode_vendor, $kode_operator, $kode_kategori_produk, $kode_produk;
