      ...
      <div class="main_portofolio">
        ...
        <div class="row row-centered">
         ...
         <a href="<?php echo site_url('gerai/pulsa/topup').'/'.'telkomsel'; ?>">
          ...
          <div class="col-md-3 col-centered col-xs-6 text-center box-gerai" style="border: 1px solid #D0D0D0;padding:20px; background: #f5f5f5">
        ...
        <div class="row row-centered">
         ...
         <a href="<?php echo site_url('gerai/pulsa/topup').'/'.'axis'; ?>">
          ...
          <div class="col-md-3 col-centered col-xs-6 text-center box-gerai" style="border: 1px solid #D0D0D0;border: 1px solid #D0D0D0;padding:20px; background: #f5f5f5">
