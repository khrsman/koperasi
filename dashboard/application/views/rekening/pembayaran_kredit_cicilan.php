...
<section class="content-header">
    <h1>
        ...
        <small>Pembayaran Kredit Cicilan</small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    ...
    <form role="form" id="form_deposito">
        <div class="row">
            <div class="col-md-9">
                <?php if($this->session->flashdata('pembayaran_kredit_cicilan_stat')) { $rek_temp = $this->session->flashdata('pembayaran_kredit_cicilan_stat'); ?>
                <div class="alert alert-success alert-dismissible">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    <h4><i class="icon fa fa-check"></i> Pembayaran Kredit Cicilan Berhasil!</h4>
                    Pembayaran kredit cicilan untuk nomor rekening kredit <?php echo $rek_temp['no_rekening_kredit'] ?> dengan jumlah setoran kredit cicilan sebesar sebesar Rp. <?php echo number_format($rek_temp['jumlah_setoran'], 2, ".", ",") ?>. Klik <a href="<?php echo base_url() ?>rekening_kredit_cicilan">disini</a> untuk melihat rekening kredit lainnya.
                </div>
                <?php } ?>
                <div class="box box-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title">Formulir isian pembayaran kredit cicilan</h3>
                    </div>
                    <div class="box-body form-input-data">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-lg-12">
                                <div class="form-group">
                                    <label for="nasabah_id">Pilih Rekening Kredit</label>
                                    <select id="nasabah_id" class="select_kredit_cicilan with-ajax search-select" name="nasabah_id" data-live-search="true"></select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <label for="jumlah_setoran">Nominal Setoran Cicilan</label>
                            ...
                            <div class="col-xs-12 col-sm-12 col-lg-12">
                                <div class="checkbox">
                                    <label for="get_charge">
                                        ...
                                        Kenai denda pembayaran cicilan?
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-lg-12">
                                <div class="checkbox">
                                    <label for="pelunasan">
                                        ...
                                        Transaksi untuk pelunasan cicilan?
                                    </label>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-lg-12 hide" id="lunas_canvas">
                                <div class="form-group">
                                    <label for="diskon">Diskon Pelunasan Kredit Cicilan</label>
                                    <div class="input-group">
                                        <span class="input-group-addon">Rp</span>
            ...
            <div class="col-md-3">
                <div class="box box-primary">
                    ...
                    <div class="box-body form-input-data">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-lg-12">
                                Pastikan pengisian pembayaran kredit cicilan nasabah sudah sesuai
                            </div>
                        </div>
                    </div>
...
<script>
    var options = {
        ajax          : {
            url     : '<?php echo $this->rekening_mod->id_koperasi ? base_url() . "rekening/cari_nasabah?mod=kredit&is_koperasi=true&status=active" : base_url() . "rekening/cari_nasabah?mod=kredit&status=active" ?>',
            type    : 'POST',
            dataType: 'json',
        ...
        locale        : {
            ...
            emptyTitle: 'Ketikan Nama, ID, atau No Rekening Kredit...',
            errorText: 'Maaf, terjadi gangguan saat menerima data. Silahkan ulangi',
            searchPlaceholder: 'Ketikan Nama, ID, atau No Rekening Kredit...',
    ...
    $('.select_kredit_cicilan').selectpicker().filter('.with-ajax').ajaxSelectPicker(options);
...
$(document).ready(function(){
    ...
    $("#form_deposito").bind('submit', function(e){
        ...
        $.ajax({
            url: '<?php echo base_url() ?>rekening/ajax_bayar_kredit_cicilan',
            data: json_data,
            dataType: 'JSON',
            type: 'POST',
            success: function(data){
                if(data.errorcode == 1){
                    ...
                    window.location.href = '<?php echo base_url() ?>bayar_angsuran_kredit_cicilan/success';
                }
            },
