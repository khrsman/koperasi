    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="alert alert-success alert-dismissible">
                ...
                Pembayaran angsuran pinjaman untuk nomor rekening <?php echo $rek_temp['no_rekening_kredit'] ?> dengan jumlah setoran sebesar Rp. <?php echo number_format($rek_temp['jumlah_setoran'], 2, ".", ",") ?>. Klik <a href="<?php echo base_url() ?>bayar_angsuran_kredit_cicilan">disini</a> untuk kembali ke halaman pembayaran angsuran.
            </div>
            <div class="box box-primary" id="nasabah_result">
                <div class="box-header with-border">
                  <h3 class="box-title">Informasi Pembayaran Kredit Cicilan</h3>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-lg-12">
                            <ul class="data-information">
                                ...
                                <li class="row">
                                    <p class="col-xs-5 col-md-5 no-padding">Kredit Cicilan Ke-</p>
            ...
            <?php } else { redirect('bayar_angsuran_kredit_cicilan'); } ?>
        </div>
    </div>
</section><!-- /.content -->
<?php 
