            ...
            <div class="col-md-12">
                <div class="box box-primary" id="nasabah_result">
                    <div class="box-header with-border">
                      <h3 class="box-title">Informasi Akumulasi Profit CIMAHI1</h3>
                    </div>
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover table-bordered">
                            <tbody>
                                ...
                                <?php if($profit_smidumay->num_rows() > 0) { foreach ($profit_smidumay->result() as $log_temp) { ?>
                                <tr>
                                    <td><?php echo $log_temp->account == "SMIDUMAY" ? "CIMAHI1" : "" ?></td>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-3">
                                ...
                                <select class="form-control" id="jenis_akun">
                                    <option value="">...</option>
                                    <option value="SMIDUMAY">CIMAHI1</option>
                                </select>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-lg-3">
...
<tr data-time="{%= res.tanggal_transaksi %}">
    ...
    <td>{%= res.jenis_akun == 'SMIDUMAY' ? 'CIMAHI1' : '' %}</td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var load_log_profit = function(offset){
            ...
            $.ajax({
                url: '<?php echo base_url() ?>rekening/ajax_load_profit_smidumay',
                data: json_data,
                dataType: 'JSON',
                type: 'POST',
