    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="action-buttons">
                <button class="btn btn-sm btn-primary" onclick=location.href="<?= base_url() ?>buat_rekening_deposito"><i class="fa fa-plus-circle"></i> &nbsp; Buat Rekening Deposito</button>
            </div>
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#rektabungan" data-toggle="tab">Rekening Deposito</a></li>
                </ul>
                    ...
                    <div class="tab-pane active" id="rektabungan">
                        <table class="dataUser table table-bordered table-striped">
                            ...
                            foreach ($nasabah_rek->result() as $nasabah_temp) { ?>
                                <tr>
                                    <td><b><?php echo $nasabah_temp->nama_lengkap ?></b></td>
                                    <td><b><?php echo $nasabah_temp->no_rekening_deposito ?></b></td>
                                    <td><?php echo $nasabah_temp->nama_koperasi ?></td>
                                    <td><?php echo $nasabah_temp->jangka_waktu ?> Bulan</td>
                                    <td style="text-align:right;">Rp. <?php echo number_format($nasabah_temp->jumlah_deposito);?>.00</td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
