                            ...
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class='input-group date datetimepicker'>
                                        <input type="text" name="tgl_register" class="form-control" id="tgl_register" placeholder="YYYY-MM-DD" value="<?php echo date('Y-m-d'); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="no_id" id="no_id"></select>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class='input-group date datetimepicker'>
                                        <input type="text" name="masa_berlaku_ktp" class="form-control" id="masa_berlaku_ktp" placeholder="YYYY-MM-DD" value="<?php echo date('Y-m-d'); ?>">
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <div class='input-group date datetimepicker'>
                                                    <input type="text" name="waris_tgl_lahir" class="form-control" placeholder="YYYY-MM-DD" id="waris_tgl_lahir">
                                                    <span class="input-group-addon">
                                                        <span class="glyphicon glyphicon-calendar"></span>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <div class='input-group date datetimepicker'>
                                                    <input type="text" name="waris_tgl_lahir2" class="form-control" placeholder="YYYY-MM-DD" id="waris_tgl_lahir2">
                                                    <span class="input-group-addon">
                                                        <span class="glyphicon glyphicon-calendar"></span>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <div class='input-group date datetimepicker'>
                                                    <input type="text" name="waris_tgl_lahir3" class="form-control" placeholder="YYYY-MM-DD" id="waris_tgl_lahir3">
                                                    <span class="input-group-addon">
                                                        <span class="glyphicon glyphicon-calendar"></span>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class='input-group date datetimepicker'>
                                                    <input type="text" name="tgl_akte_awal" class="form-control" placeholder="YYYY-MM-DD" id="tgl_akte_awal">
                                                    <span class="input-group-addon">
                                                        <span class="glyphicon glyphicon-calendar"></span>
                                                    </span>
                                                </div>
...
<script>
    ...
    $('.selectpicker').on('change', function(){
        ...
        if (selected) {
            var json_data = {id_user: selected};
            $.ajax({
                url: '<?php echo base_url() ?>rekening/ajax_info_anggota',
                data: json_data,
                dataType: 'JSON',
                type: 'POST',
                success: function(data){
                    if(data.errorcode == 1){
                        ...
                        $("#nama_nasabah").val(data.data.fullname ? data.data.fullname : "");
                        $("#nama_alias").val(data.data.alias ? data.data.alias : "");
                        $("#jenis_kelamin").val(data.data.gender ? data.data.gender : "");
                        $("#kode_agama").val(data.data.religion ? data.data.religion : "");
                        $("#tempat_lahir").val(data.data.birth_place ? data.data.birth_place : "");
                        $("#tgl_lahir").val(data.data.date_of_birth ? data.data.date_of_birth : "");
                        $("#jenis_id").val(data.data.id_type ? data.data.id_type : "");
                        $("#no_id").val(data.data.id_number ? data.data.id_number : "");
                        $("#provinsi").val(data.data.province ? data.data.province : "");
                        $("#kodepos").val(data.data.postal_code ? data.data.postal_code : "");
                        $("#alamat").val(data.data.address ? data.data.address : "");
                        $("#telpon").val(data.data.phone_number1 ? data.data.phone_number1 : "");
                        $("#hp").val(data.data.phone_number2 ? (data.data.phone_number2 ? data.data.phone_number2 : data.data.phone_number3) : "");
                        $("#kode_group2").val(data.data.last_education);
                        if(data.data.city){
                            $.ajax({
                                url: '<?php echo base_url() ?>rekening/ajax_get_city',
                                data: {province_id: data.data.province},
                                mode: 'queue',
                                type: 'POST',
                                success: function(data_city){
                                    $("#kota_kab").html(tmpl('tmpl-list-city', data_city.data));
                                    $("#kota_kab").val(data.data.city);
                                }
                            });
                        }
                    }
