...
<section class="content-header">
    <h1>
        Informasi Rekening Tabungan Nasabah
        <small>Histori dan Detail Rekening Tabungan Nasabah</small>
    </h1>
    <ol class="breadcrumb">
...
{% if(o) { %}
    <div class="form-input-data">
        ...
        {% if(o.sumber_dana == "TUNAI") { if(o.jenis_transaksi != "SETORAN AWAL") { %}
        ...
        {% } } else if(o.jenis_transaksi != 'PENARIKAN SALDO'){ %}
        <ul class="data-information transaction-log-bottom">
            <li class="row">
