        ...
        <br>
        <!-- Main content -->
        <section class="content container gray-wrapper" style="background:#EEEDED;">
                    ...
                    <div class="col-md-6">
                        <div class="box box-primary">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-primary full-width" style="color:black;"><b>Lakukan Transaksi</b></button>
