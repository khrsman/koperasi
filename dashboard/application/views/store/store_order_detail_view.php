	        	...
	        	<div class="col-md-12">
			 		...
			 		<table class="table table-bordered" style="border:2px solid #eee !important">
			          	...
			          	<tr>
			          		<td>Status</td>
			          		<td>
			          			<b><?php echo $order_detail[0]['status_terkirim']=='N'?'Belum Terkirim':'Terkirim'; ?></b>
			          			&nbsp&nbsp
			          			<a href="<?php echo site_url('store_order/edit_status').'/'.$order['no_transaksi']; ?>" class="btn btn-sm btn-info">Ubah</a>
			          		</td>
			          	</tr>
