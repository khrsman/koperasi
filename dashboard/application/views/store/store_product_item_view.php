  <div class="row">
    ...
    <?php if($product['owner']==2 || $product['owner']==1): ?>
    <div class="col-md-12">
      <div>
        <h4><b><?php echo $koperasi['nama_koperasi']; ?> <small>( ID KOPERASI: <?php echo $koperasi['id_koperasi']; ?> )</small><br>
          <small>
    ...
    <?php if($product['owner']==3):?>
    <div class="col-md-12">
      <div>
        <h4><b><?php echo $product_owner['detail']['nama_lengkap']; ?> <small>( ID USER: <?php echo $product_owner['detail']['id_user']; ?> )</small><br>
          <small>
            KEL. <?php echo $product_owner['detail']['kelurahan']; ?>, KEC. <?php echo $product_owner['detail']['kecamatan']; ?>, <?php echo $product_owner['detail']['kabupaten']; ?>, PROV. <?php echo $product_owner['detail']['provinsi']; ?><?php echo !empty($product_owner['detail']['kode_pos'])?', KODE POS '.$product_owner['detail']['kode_pos']:''; ?>
            <br>
            <b>Alamat : <?php echo $product_owner['detail']['alamat']; ?></b>
          </small>
        </h4>
        <hr>
      </div>
    ...
    <div class="col-md-4">
      ...
      <?php if($product['owner']==3): ?>
      <a href="<?php echo site_url('store/product/member'); ?>" class="btn btn-default btn-block"><i class="fa fa-shopping-bag" style="margin-right:7px"></i>Lihat Produk Lain</a>
      <?php endif; ?>
    </div>
