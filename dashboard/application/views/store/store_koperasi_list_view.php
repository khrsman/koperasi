<!-- <div class="container" style="margin-top:80px;"> -->
  ...
  <div class="row multi-columns-row">
    ...
    <div class="col-md-12">
      <div class="row">
        <div class="col-md-6">
          <a href="<?php echo site_url('store/koperasi'); ?>" class="btn btn-default btn-lg btn-block">Produk Koperasi</a>
        </div>

        <div class="col-md-6">
          <a href="<?php echo site_url('store/product/member'); ?>" class="btn btn-primary btn-lg btn-block">Produk Anggota</a>
        </div>
      </div>
      <br>
    </div>
      ...
      <form class="form-horizontal" action="<?php echo $form_action; ?>" method="GET" >
        <div class="box box-info">
            ...
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-search" style="margin-right:7px"></i> Cari BUMDES</h3>
            </div>
            ...
            <div class="box-body">
              <div class="rows">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <button type="submit" class="btn btn-success"><i class="fa fa-search" style="margin-right:7px"></i> Cari BUMDES</button>
                        &nbsp;atau&nbsp;
                        <a href="<?php echo site_url('store/product').'?filter_koperasi='.$this->session->userdata('koperasi'); ?>" class="btn btn-default"><i class="fa fa-shopping-bag" style="margin-right:7px"></i> BUMDES Saya</a>
                      </div>
                  </div>
    ...
    <div class="col-md-12">
      ...
      <form class="form-horizontal" action="<?php echo $form_action; ?>" method="GET" >
        <div class="box box-info">
            ...
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-globe" style="margin-right:7px"></i> Hasil Pencarian</h3>
            </div>
            ...
            <div class="box-body">
              <div class="rows">
                  ...
                  <?php foreach ($koperasi as $k => $v): ?>  
                  <div>
                    <h4><b><?php echo $v['nama_koperasi']; ?> <small>( ID : <?php echo $v['id_koperasi']; ?> )</small><br>
                      <small>
                        ...
                        <br>
                        <b>Alamat : <?php echo $v['alamat_koperasi']; ?></b>
                      </small>
                    </h4>
                    <a href="<?php echo site_url('store/product').'?filter_koperasi='.$v['id_koperasi']; ?>" class="btn btn-info btn-xs"><i class="fa fa-shopping-cart" style="margin-right:7px"></i> Lihat Produk</a>
                    <hr>
                  </div>
                  <?php endforeach; ?>

                  <?php else: ?>
                   <h4 class="text-muted text-center">DATA TIDAK DITEMUKAN</h4> 
