  <div class="row">
    ...
    <div class="col-md-4">
        ...
        <select class="form-control select-redirect">
          ...
          <?php foreach($filter_product_category as $k => $v): ?>
            ...
            <option value="<?php echo site_url('store/product/member').update_query_string('filter_product_category',$v['alias']); ?>" <?php if($v['alias']==$param_filter_product_category){echo 'selected';} ?>><?php echo $v['alias']; ?></option>
    ...
    <div class="col-md-4">
      ...
      <?php  
        ...
        echo form_open(site_url('store/product/member'),$attributes);
      ?>
