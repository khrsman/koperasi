...
<body class="sidebar-mini skin-black-light fixed">
    ...
    <div class="wrapper">
        ...
        <div class="run-text">
            <div class="col-md-12 col-xs-12" style="padding-top: 50px; padding-bottom : 5px; padding-left: 0px; padding-right:0px;border-bottom:1px solid #D4D4D4;background: #1BBC9B;color: white;font-size: 18px;">
