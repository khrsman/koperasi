...
<li><a href="<?= base_url()."store/cart" ?>"><i class="fa fa-cart-plus"></i> Lihat Keranjang Belanja</a></li>
<!-- <li class="treeview">
    <a href="#">
...
<li><a href="<?php echo base_url() ?>rekening_favorit"><i class="fa fa-gift"></i> Daftar Rekening Favorit</a></li>
