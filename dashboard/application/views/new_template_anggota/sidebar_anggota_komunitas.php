...
<li class="header"  style="background:#C5FFAD;color:black;"><img src="<?php echo base_url('assets/compro/dashboard').'/lite-konten.png'; ?>" class="img-responsives" width="30px" style="margin:0 22px 0 0" ><font size="2px">LAINNYA</font></li>
<li class="treeview">
       <a href="#">
