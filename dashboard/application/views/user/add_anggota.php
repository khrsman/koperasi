...
<link rel="stylesheet" href="<?= base_url() ?>assets/AdminLTE-2.0.5/plugins/datepicker/datepicker3.css" type="text/css">
...
<section class="content">
    ...
    <div class="box">
        ...
        <form action="" method="post" action="<?= base_url() ?>/add_anggota" enctype="multipart/form-data">
          ...
          <div class="col-md-3">
           ...
           <div class="col-md-3">
            <div class="form-group ">
              ...
              <input type="password" class="form-control" placeholder="Password" required="" name="confirm_password" value="<?= set_value('password')?>"/>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group ">
          ...
          <div class="col-md-3">
            <div class="form-group ">
              <label for="pin">Tanggal Efektif Polis</label>
              <input type="text" class="form-control" placeholder="Tanggal Efektif Polis" required=""  name="mulai_polis" value="<?= set_value('mulai_polis')?>" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group ">
              <label for="pin">Tanggal Berakhir Polis</label>
              <input type="text" class="form-control" placeholder="Tanggal Berakhir Polis" required=""  name="akhir_polis" value="<?= set_value('akhir_polis')?>" />
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group ">
          ...
          <div class="col-md-3">
            <div class="form-group ">
              <label for="jum_motor">Jumlah Sepeda Motor Dimiliki</label>
...
<script src="<?= base_url() ?>assets/AdminLTE-2.0.5/plugins/daterangepicker/moment.js" type="text/javascript"></script>
<script src="<?= base_url() ?>assets/AdminLTE-2.0.5/plugins/datepicker/bootstrap-datepicker.js" type="text/javascript"></script>
...
$(function() {
    $('input[name="mulai_polis"]').datepicker();
    $('input[name="akhir_polis"]').datepicker();
});
</script>
<script type="text/javascript">
  $(".polis").select2({
    ajax: {
    url: "<?= base_url() ?>Anggota/select_polis",
    dataType: 'json',
    delay: 250,
