...
<div class="col-md-7">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Tambah Majalah</h3>
        </div>
        <div class="box-body">
            <form method="post" action="<?= base_url() ?>tambah_majalah" enctype="multipart/form-data">
                 <div class="form-group ">
                    <label for="judul">Judul Majalah</label>
                    <input type="text" class="form-control" placeholder="Judul Majalah" required=""  name="judul" />
                  </div>
                   <div class="form-group ">
                        <label for="isi_agenda">Deskripsi Majalah</label>
                        <textarea id="mytextarea" class="form-control" name="deskripsi" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                    </div>
                     <div class="form-group ">
                        <label for="foto">Upload File Majalah</label>
