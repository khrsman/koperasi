            ...
            <div class="col-xs-12">
              ...
              <div class="box">
              	<div class="box-header with-border">
              		<button class="btn btn-sm btn-success" onclick=location.href="<?= base_url() ?>add_komunitas"><i class="fa fa-plus-circle"></i> Tambah Komunitas</button>
                  ...
                  <table id="dataUser" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    	<?php foreach ($komunitas as $r) { ?>
                            ...
                            <td><?= $r->alamat?></td>
                            <td><?= $r->telp?></td>
                    				<td><?= $r->ketua_komunitas ?></td>
                    				<td>
                    					<button class="btn btn-success" onclick=location.href="<?= base_url()?>edit_komunitas/<?= $r->id_komunitas ?>"><i class="fa fa-pencil"></i></button>
                    					<button class="btn btn-danger" onclick=confirmHapus(<?= $r->id_komunitas?>)><i class="fa fa-trash"></i></button>
                    				</td>
                    			</tr>
                    	<?php } ?>
                    </tbody>
       ...
       function confirmHapus(id)
          {
               ...
               {
                  window.location.href='<?= base_url() ?>delete_komunitas/'+id;
               }
          }
          </script>
    </script>
