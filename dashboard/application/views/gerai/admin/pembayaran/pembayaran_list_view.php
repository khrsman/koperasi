    ...
    <div class="row">
      ...
      <div class="main_portofolio">
        ...
        <div class="row row-centered">
         ...
         <a href="<?php echo site_url('gerai/admin/listrik/pln_pascabayar'); ?>">

          <div class="col-md-2 col-centereds col-xs-6 text-center box-gerai" style="padding:20px; margin: auto auto;border:1px solid #D0D0D0;">
         ...
         <a href="<?php echo site_url('gerai/admin/listrik/pln_prabayar'); ?>">
         ...
         <a href="<?php echo site_url('gerai/admin/internet/speedy'); ?>">
         ...
         <a href="<?php echo site_url('gerai/admin/telepon/telkom'); ?>">
