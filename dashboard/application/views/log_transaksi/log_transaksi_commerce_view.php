				...
				<div class="box-body">
					<div class="row">
						<div class="col-xs-12 col-sm-5 col-lg-5">
							...
							echo form_open(site_url('transaksi/commerce'),$attributes);
							?>
							...
							<div class="box-body">
								<table id="table-1" class="table table-bordered table-consended table-hover">
									...
									<tbody>
										...
										<tr>
											<td><?php echo $v['no_transaksi']; ?></td>
											<td><?php echo $v['nama_lengkap']; ?></td>
											<td><?php echo $v['nama']; ?></td>
											<td><?php echo $v['tanggal_transaksi']; ?></td>
											<td style="text-align:right"><?php $th = str_replace(".00", "", $v['total_harga']);
                                                                echo number_format($th,0,".",",") ?></td>
											<td>
												<a href="<?= base_url() ?>get_detail_transaksi/<?php echo $v['no_transaksi']; ?>" class="btn btn-info">
