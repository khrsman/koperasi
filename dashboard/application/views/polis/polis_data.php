          ...
          <div class="box-header with-border">
            ...
            <div class="row">
              ...
              <div class="col-md-4 pull-right">
                <button class="btn btn-success pull-right" onClick=location.href="<?= base_url()?>add_polis"><i class="fa fa-plus-circle"></i> Tambah Polis</button>
              </div>
            </div>
            </div><!-- /.box-header -->
            <div class="box-body">
              <table id="table-1" class="table table-bordered table-consended table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                              <a class="btn btn-success" href="<?= base_url()?>edit_polis/<?= $v['id_polis'] ?>"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
      function confirmHapus(id)
      {
           ...
           {
              window.location.href='<?= base_url() ?>delete_polis/'+id;
           }
      }
</script>
<script type="text/javascript">
