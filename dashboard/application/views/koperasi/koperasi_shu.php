...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#">Data SHU Koperasi</a></li>
  </ol>
</section>
<!-- Main content -->
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-xs-12 col-sm-8 col-lg-8">
            ...
            echo form_open(site_url((('shu_koperasi'))),$attributes);
            ?>
            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <select class="text-muted select-redirect">
                  ...
                  <option value="<?php echo site_url((('shu_koperasi'))).update_query_string('sort',$v['alias']); ?>" <?php if($v['alias']==$param_sort){echo 'selected';} ?>><?php echo $v['alias']; ?></option>
                  <?php endforeach; ?>
                </select>
                <select class="text-muted select-redirect">
                  <?php foreach($sort_order as $k => $v): ?>
                  <option value="<?php echo site_url((('shu_koperasi'))).update_query_string('sort_order',$v['alias']); ?>" <?php if($v['alias']==$param_sort_order){echo 'selected';} ?>><?php echo $v['alias']; ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
            </div>
              ...
              <table id="table-1" class="table table-bordered table-consended table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> 
                        <a class="btn btn-primary" href="<?= base_url()?>koperasi/shu/<?= $v['id_koperasi'] ?>"><i class="fa fa-line-chart"></i></a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                  <?php endif; ?>
