    ...
    <div class="row">
      ...
      <div class="main_portofolio">
        ...
        <div class="row row-centered">
         ...
         <a href="<?php echo site_url('gerai/listrik/pln_pascabayar'); ?>">
         ...
         <a href="<?php echo site_url('gerai/listrik/pln_prabayar'); ?>">
         ...
         <a href="<?php echo site_url('gerai/internet/speedy'); ?>">
         ...
         <a href="<?php echo site_url('gerai/telepon/telkom'); ?>">
