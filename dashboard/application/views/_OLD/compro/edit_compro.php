...
<div class="col-md-7"><?= validation_errors() ?></div>
        ...
        <div class="col-md-5">
            <div class="box">
                <div class="box-body">
                    <img src="<?= base_url() ?>assets/images/compro/<?php if ($compro['link_gambar'] != NULL )
                                                                    echo $compro['link_gambar']; 
                                                                    else 
                                                                    echo 'default.png';?>" class="img-responsive">
                    <form method="post" action="<?= base_url() ?>edit_foto_compro" enctype="multipart/form-data">
        ...
        <div class="col-md-7">
            <div class="box">
            <form method="post" action="<?= base_url() ?>update_compro">
                <div class="box-header with-border">
                   <div class="form-group ">
                    <input type="text" class="form-control" placeholder="Judul Compro" required=""  name="judul" value="<?= $compro['judul'] ?>" />
                  </div>
                </div>
                <div class="box-body">
                    <div class="form-group ">
                        <textarea id="mytextarea" class="form-control" name="isi" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $compro['isi'] ?></textarea>
                    </div>
