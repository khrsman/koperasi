...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#">Data Koperasi Induk</a></li>
  </ol>
</section>
<!-- Main content -->
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-xs-12 col-sm-8 col-lg-8">
            ...
            echo form_open(site_url('koperasi'),$attributes);
            ?>
            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <select class="text-muted select-redirect">
                  ...
                  <option value="<?php echo site_url('koperasi').update_query_string('sort',$v['alias']); ?>" <?php if($v['alias']==$param_sort){echo 'selected';} ?>><?php echo $v['alias']; ?></option>
                  <?php endforeach; ?>
                </select>
                <select class="text-muted select-redirect">
                  <?php foreach($sort_order as $k => $v): ?>
                  <option value="<?php echo site_url('koperasi').update_query_string('sort_order',$v['alias']); ?>" <?php if($v['alias']==$param_sort_order){echo 'selected';} ?>><?php echo $v['alias']; ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
              
              <div class="col-md-9">
                <a class="btn btn-sm btn-success pull-right" href="<?= base_url() ?>add_koperasi"><i class="fa fa-plus-circle"></i> Tambah Koperasi</a>
              </div>
            </div>
            </div><!-- /.box-header -->
            <div class="box-body">
              <table id="table-1" class="table table-bordered table-consended table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> 
                        <a class="btn btn-success" href="<?= base_url()?>edit_koperasi/<?= $v['id_koperasi'] ?>"><i class="fa fa-pencil"></i></a>
                        <a href="<?= base_url() ?>delete_koperasi/<?= $v['id_koperasi']?>" class="btn btn-danger"onclick="return confirm('Anda Yakin Untuk Menghapus data ?');"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                  <?php endif; ?>
