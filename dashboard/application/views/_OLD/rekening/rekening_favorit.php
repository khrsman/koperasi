...
<section class="content-header">
    ...
    <div class="box-buttons">
        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#tambah_rekening_fav"><i class="fa fa-plus-circle"></i> &nbsp; Tambah Rekening Favorit</button>
    </div>
</section>
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="form_rekening_favorit">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary">Simpan Nomor Rekening</button>
            </div>
        </form>
        </div>
    </div>
