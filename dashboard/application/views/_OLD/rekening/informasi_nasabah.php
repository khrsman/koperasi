...
<section class="content">
    ...
    <form role="form" id="form_cek_saldo">
        <div class="row">
            ...
            <div class="col-md-4 col-xs-12">
                <?php if($rekening_loyalti->num_rows() > 0) { $rek_temp = $rekening_loyalti->row(); ?>
                <div class="box box-success" id="insurance_result">
                    <div class="box-header with-border">
                        <h3 class="box-title">Rekening Loyalti Nasabah</h3>
                    </div>
                    <div class="box-body form-input-data">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-lg-12">
                                <ul class="data-information">
                                    ...
                                    <li class="row">
                                        <p class="col-xs-5 col-md-5 no-padding">Saldo Rekening</p>
                                        <p class="col-xs-7 col-md-7 no-padding"><b>Rp. <span><?php echo number_format($rek_temp->saldo_loyalti, 2, ".", ",") ?></span></b></p>
                                    </li>
                                    <li class="row">
                                        <p class="col-xs-5 col-md-5 no-padding">Histori Transaksi</p>
                                        <p class="col-xs-7 col-md-7 no-padding"><b><span><a href="<?php echo base_url() .'nasabah/'. $rek_temp->id_user . '/loyalti' ?>">Lihat Histori Transaksi</a></span></b></p>
                                    </li>
                                </ul>
                            </div>
                        </div>
