...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#">Data Anggota Koperasi</a></li>
  </ol>
</section>
<!-- Main content -->
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-xs-12 col-sm-6 col-lg-6">
            ...
            echo form_open(site_url('anggota'),$attributes);
            ?>
              ...
              <table id="table-1" class="table table-bordered table-consended table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                              <a class="btn btn-success" href="<?= base_url()?>edit_anggota/<?= $v['user_id'] ?>"><i class="fa fa-pencil"></i></a>
                               <a href="<?= base_url() ?>delete_anggota/<?= $v['user_id']?>" class="btn btn-danger"onclick="return confirm('Anda Yakin Untuk Menghapus data ?');"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                  <?php endif; ?>
