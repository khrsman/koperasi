      ...
      <div class="main_portofolio">
        ...
        <div class="row row-centered">
         ...
         <a href="<?php echo site_url('gerai/pulsa/topup').'/'.'esia'; ?>">
          ...
          <div class="col-md-2 col-centered col-xs-6 text-center box-gerai" style="padding:20px; margin: auto auto; 'background': #70baaa">
          ...
          <div class="col-md-2 col-centered col-xs-6 text-center box-gerai " style="padding:20px; margin: auto auto; 'background': orange">
         ...
         <a href="<?php echo site_url('gerai/pulsa/topup').'/'.'flexi'; ?>">
           ...
           <div class="col-md-2 col-centered col-xs-6 text-center box-gerai" style="padding:20px; margin: auto auto; 'background': #4fa4da">
