...
<!-- <li class="active"><a href="<?= base_url()."store/l" ?>"><i class="fa fa-cart-plus"></i> Lihat Produk Belanja Online</a></li> -->
...
<li class="treeview <?php echo $gerai;?>">
       <a href="<?= base_url()."gerai" ?>" onclick="get_gerai()">
        <i class="fa fa-qrcode"></i> <span>Produk Gerai Lumrah</span>
        <i class="fa fa-angle-left pull-right"></i>
        </a>
...
<li class="header"  style="background:#FFDDAD;color:black;"><img src="<?php echo base_url('assets/compro/dashboard').'/lite-report.png'; ?>" class="img-responsives" width="30px" style="margin:0 22px 0 0" ><font size="2px"><b>MANAGEMENT LAPORAN</b></font></li>
            <li>
