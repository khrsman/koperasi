            ...
            <?php
              ...
              <div class="box">
              	<div class="box-header with-border">
              		<button class="btn btn-sm btn-success" onclick=location.href="<?= base_url() ?>add_anggota"><i class="fa fa-plus-circle"></i> Tambah Anggota</button>
                    ...
                    <tbody>
                      <?php foreach ($anggota as $r) { ?>
                          <tr>
                            ...
                            <td><?= $r->nama ?></td>
                            <td>
                              <button class="btn btn-success" onclick=location.href="<?= base_url()?>edit_anggota/<?= $r->id_user ?>"><i class="fa fa-pencil"></i></button>
...
<!--tambahkan custom js disini-->
    ...
    <script src="<?= base_url() ?>assets/AdminLTE-2.0.5/plugins/datatables/dataTables.bootstrap.js" type="text/javascript"></script>
      ...
      function confirmHapus(id)
      {
           ...
           {
              window.location.href='<?= base_url() ?>delete_anggota/'+id;
           }
      }
      </script>
