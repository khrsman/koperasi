            ...
            <?php
              ...
              <div class="box">
                <div class="box-header with-border">
                  <button class="btn btn-sm btn-success" onclick=location.href="<?= base_url() ?>add_admin"><i class="fa fa-plus-circle"></i> Tambah Admin</button>
                    ...
                    <tbody>
                      <?php foreach ($admin as $r) { ?>
                          <tr>
                            ...
                            <td><?= $r->telp ?></td>
                            <td>
                              <button class="btn btn-success" onclick=location.href="<?= base_url()?>edit_admin/<?= $r->id_user ?>"><i class="fa fa-pencil"></i></button>
