	   ...
	   function list_transaksi()
	{
        ...
        $keyword_by = array(
            array(
                ...
                'parameter'=> array
                        (   
                            'gerai_transaksi.no_transaksi_pulsa'      => $keyword,
                            'user_detail.nama_lengkap'                => $keyword,
                        ),
                ),
      
            array(
                'alias'     =>'no_transaksi_pulsa',
                'parameter' =>'gerai_transaksi.no_transaksi_pulsa',
                ),
            array(
                'alias'     =>'nama',
        ...
        $def_param_sort = 'gerai_transaksi.no_transaksi_pulsa';
        $param_sort         = strtolower($this->input->get('sort'));
        $data['param_sort'] = 'no_transaksi_pulsa';
        if (isset($param_sort)) {
