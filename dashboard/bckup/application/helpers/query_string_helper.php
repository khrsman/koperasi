...
{	
	...
	if (isset($new_parsed_uri['filter_tanggal'])&&isset($new_parsed_uri['filter_bulan'])&&isset($new_parsed_uri['filter_tahun'])) {
		unset($new_parsed_uri['filter_tanggal']);
		unset($new_parsed_uri['filter_bulan']);
		unset($new_parsed_uri['filter_tahun']);
	}

	if (isset($new_parsed_uri['filter_bulan'])&&isset($new_parsed_uri['filter_tahun'])) {
		unset($new_parsed_uri['filter_bulan']);
		unset($new_parsed_uri['filter_tahun']);
	}
	if (isset($new_parsed_uri['filter_tahun'])) {
		unset($new_parsed_uri['filter_tahun']);
	}
	if (isset($new_parsed_uri['filter_koperasi'])) {
		unset($new_parsed_uri['filter_koperasi']);
	}
...
function search_hidden_query_string_store() 
{	
