    ...
    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
          ...
          <b style="color:gray">Rp. <?php echo "Harga Pasar : ".$str_price_n; ?></b><br>
          <b style="color:#d4232b">Rp. <?php echo "Harga Member : ".$str_price_s; ?></b>
          <p>
            <span class="bg-blue"style="padding:0 5px;">Savings Rp. <?php echo $diskon; ?></span>
          </p>
