   ...
   <div class="container">
      ...
      <div class="col-md-6 col-xs-12 login-box">
        ...
        <div class="login-box-body">
          <p class="login-box-msg">Silahkan masukan username dan password anda, untuk melihat fitur kami selanjutnya.</p>
          <?php
          ...
          <?php echo form_open($action_form); ?>
            ...
            <div class="row">
              ...
              <div class="col-xs-12">
                ...
                <button type="button" class="btn btn-success btn-block btn-flat" onclick=location.href="<?= base_url() ?>auth/choose_register/1">Daftar</button>
