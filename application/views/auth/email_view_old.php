                            ...
                            <table>
                              <tr>
                                <th> <br>
                                  <br>
                                  <h1>Hi, <?= $nama ?></h1>
                                  <p class="lead">Kami mendapatkan permintaan untuk me-reset password CIMAHI1 anda.</p>
                                  <br>
                                  <br>
                                  <a style="color:#2b5a83;text-decoration:none;border-radius:3px;border:1px solid #2b5a83;padding:10px 19px 12px 19px;font-size:17px;font-weight:500;white-space:nowrap;border-collapse:collapse;display:inline-block;font-family:Helvetica Neue,Helvetica,Arial,sans-serif" href="<?= $link ?>" target="_blank">Reset Password</a>
                                  <table class="callout">
                                    <tr>
                                      <td class="callout-inner primary">
                                        <p>Jika anda merasa bahwa ini kesalahan, abaikan email ini.</p>
                                      </td>
