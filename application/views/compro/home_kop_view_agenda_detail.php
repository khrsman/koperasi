...
<section class="white-wrapper" style="padding: 20px 0;">
  <div class="compro-canvas">
    ...
    <div class="compro-nav">
      <ul>
        <li><a href="<?php echo base_url('koperasi/'.$koperasi->id_koperasi.'/'.convert_to_url($koperasi->nama).'/agenda') ?>"<?php echo $this->uri->segment(4) == "agenda" || !$this->uri->segment(4) ? " class='active'" : "" ?>>agenda</a></li>
        ...
        <div class="box-content">
          <div class="content-page">
            ...
            <div class="content-thumbnail">
              <img src="<?php echo base_url('dashboard/assets/images/agenda/'.$content_temp->link_gambar) ; ?>">
            </div>
            <?php } ?>
            <div class="content-event">
              Tanggal Pelaksanaan: <?php echo $content_temp->tanggal_agenda ?>
            </div>
