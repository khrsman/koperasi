<div class="page-banner" style="padding:70px 0 20px 0;background: url(images/slide-02-bg.jpg) center #f9f9f9;">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h2 class="text-center">BADAN KONTAK MAJELIS TAKLIM - MUKATAMAR 2016</h2>
	...
	<article class="post">
		<header class="entry-header">
			<div class="entry-thumb">
				<img width="100%" height="360" alt="Blog 01" class="attachment-post-thumbnail" src="<?php echo base_url();?>assets/compro/landing_page/bkmt-muktamar.jpg">
				</div><!-- .entry-thumb -->
				</header><!-- .entry-header -->
				<div class="entry-content">
					<div class="entry-meta">
						<div class="post-meta">
							<span class="posted-on">Posted on <a rel="bookmark" href="#"><time datetime="2015-04-16 20:00">March 5, 2016</time></a></span>
							<span class="byline"> by <span class="author vcard"><a href="#">admin</a></span></span>
							</div><!-- .post-meta -->
							</div><!-- .entry-meta -->
							<p>Badan Kontak Majelis Taklim (BKMT) lahir di Jakarta tanggal 25 Safar 1401 h/01 Januari 1981 M dari kesepakatan 732 Majelis Taklim. BKMT lahir dari sebuah gagasan untuk menyatukan semangat dan harapan pembinaan ummat melalui wadah pembelajaran yang khas dimiliki oleh ummat Islam yaitu Majelis Taklim. Kini BKMT sudah tersebar di 32 Propinsi dan 400 Kabupaten di Indonesia dan anggotanya hampir mencapai + 15.000.000 (lima belas juta) jiwa.</p>
