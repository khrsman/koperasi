         ...
         <article class="post">
            ...
            <div class="entry-content">
               <div class="entry-meta">
                  <h3 class="entry-title">Agenda Muktamar Tanggal 10 Maret 2016</h3>
                  <div class="post-meta">
                     <span class="posted-on">Posted on <a rel="bookmark" href="#"><time datetime="2015-04-16 20:00">Maret 01, 2016</time></a></span>
                     <span class="byline"> by <span class="author vcard"><a href="#">admin</a></span></span>
                  </div>
                  <!-- .post-meta -->
               </div>
               <!-- .entry-meta -->
               <p><strong>Daftar Kegiatan Rabu, 10 Maret 2016</strong></p>
               <h4>Seminar International dan Pembukaan Muktamar VIII BKMT</h4>
               <ul class="mgb40">
                  <li>Waktu  : Pkl. 08.30 - 12.30 WIB</li>
                  <li>Tempat : Plaza Universitas Islam As-Syafi'iyah</li>
               </ul>


               <h4>Mukatamar VIII BKMT</h4>
               <ul class="mgb40">
                  <li>Waktu  : Pkl. 13.30 WIB - Selesai</li>
                  <li>Tempat : Plaza Universitas Islam As-Syafi'iyah</li>
               </ul>
